...
QuicShell} door \emph{Das, Somak R} van de universiteit\emph{ Massachusetts Institute of Technology} zal een zeer interessante bron zijn voor dit onderzoek. In deze thesis bestudeert De heer \emph{Das, Somak R} de performantie van QUIC op een webpagina.\cite{PaperDas}
